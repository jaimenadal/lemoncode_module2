...
docker run -d --name backend --network node-stack_lemoncode -p 5000:5000 -e MONGODB_URL=mongodb://mongo:27017 -e DATABASE_NAME=LemoncodeCourseDb lemoncode-backend
